        ...
        <div className="columns is-vcentered has-text-centered">
          <div className="column box wunderback has-text-centered">
            ...
            <div className="buttons is-grouped is-centered mt-3">
              <a className="shopb button mr-2 is-dark" onClick={() => {window.open("https://www.wundergrubs.com/store/c1/Featured_Products.html")}}>SHOP NOW</a>
              <a className="shopb button ml-1 is-dark" onClick={() => {window.open("https://www.instagram.com/wundergrubs/")}}>INSTAGRAM</a>
            </div>
          </div>
